            ...
            >
              ...
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item" style={{ height: "60px" }}>
                  <div className="row">
                    <div className="col-md-2"><span className="li-key">ORIGIN </span></div>
                    <div className="col-md-10"> <span className="li-value">{item.origin.name}</span></div>
                  </div>
                </li>
                <li className="list-group-item li-last-item" >

                <div className="row">
                    <div className="col-md-2"><span className="li-key">LAST LOCATION </span></div>
                    <div className="col-md-10"> <span className="li-value">{item.location.name}</span></div>
                  </div>
                </li>
              </ul>
            </div>
